...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    @Override
    public void updateMoney(Integer money, String userId,String cid) {
        SqlSession session = MyBatisUtils.getSession();
        try {
            if (session != null) {
...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    public Player findByOpenId(String openId,String cid){
        Player result = null;
        System.out.println("findByOpenId openId" + openId+cid);
        SqlSession session = MyBatisUtils.getSession();
        try {
            if (session != null){
...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    @Override
    public void updateUserAgree(Long userId,String cid) {
        SqlSession session = MyBatisUtils.getSession();
        try {
            if (session != null) {
    ...
    public String getNotice(String cid) {
        ...
        try {
            if (session != null){
                ...
                System.out.println("sql name ==>>" + sqlName);
                result = session.selectOne(sqlName,cid);
                session.close();
            }
        }catch (Exception e){
...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    @Override
    public Integer getUserMoneyByUserId(Long userId,String cid) {
        Integer result = null;
	...
	@Override
	public void updateIpAndLastTime(String openId,String ip,String cid) {
		 SqlSession session = MyBatisUtils.getSession();
	        try {
	            if (session != null) {
...
//	                MyBatisUtils.closeSessionAndCommit();
	...
	public void updateInfo(Player p) {
		 SqlSession session = MyBatisUtils.getSession();
	        try {
	            if (session != null) {
	                String sqlName = UserMapper.class.getName() + ".updateInfo";
	                Map<Object, Object> map =new HashMap<>();
